...
---
GROUP MEMBERS
180709061 - Hakkıcan BÜLÜÇ
180709018 - Hüseyin ÇOBAN
200709078 - Adem VAROL

Data Summary (ADEM VAROL)
...
#Ortalama
mean(df$ORTALAMA)
oalMean <- mean(filter(df, OKUL == "OAL"))
yealMean <- mean(filter(df, OKUL == "YEAL"))
