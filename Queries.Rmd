...
QUESTIONS: 1. Are students living in the village more successful than those living in the city center?
...
2.  Are girls or boys most negatively affected by the separation of parents ?
...
3.  Which attribute is more important to success?
...
4.  Can a new student get a passing grade?
...
## 5.  At which grade level is the educational status of the parents more effective?
...
dt9 <- filter(dt9, `Anne veya baba en fazla ilkokul mezunu mu?` == 0)
dt10 <- filter(dt10, `Anne veya baba en fazla ilkokul mezunu mu?` == 0)
dt11 <- filter(dt11, `Anne veya baba en fazla ilkokul mezunu mu?` == 0)
dt12 <- filter(dt12, `Anne veya baba en fazla ilkokul mezunu mu?` == 0)
